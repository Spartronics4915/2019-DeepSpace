...
public class PhysicsTest
{
         ...
         * 1.499, 1.501};
         * double[] speeds = new double[]{0.0, 0.1, -0.5, 130.1, 3000.0, -45.0,
         * 666.666};
         * for (double speed : speeds) {
         * for (double voltage : voltages) {
         * double torque = motor.getTorqueForVoltage(Units.rpm_to_rads_per_sec(speed),
         * voltage);
         * if (Math.abs(voltage) <= 1.5 && Util.epsilonEquals(speed, 0.0)) {
         * assertEquals(0.0, torque);
         * } else {
         * assertEquals(voltage,
         ...
         * DCMotorTransmission transmission = new
         * DCMotorTransmission(Units.rpm_to_rads_per_sec(65.0), 0.35, 1.0);
         * DifferentialDrive drive = new DifferentialDrive(70.0, 84.0,
         * Units.inches_to_meters(2.0), Units
         * .inches_to_meters(25.5) / 2.0, transmission, transmission);
         * // Kinematics
         * DifferentialDrive.ChassisState velocity = drive.solveForwardKinematics(new
         * DifferentialDrive.WheelState(0.0,
         * 0.0));
         ...
         * velocity = drive.solveForwardKinematics(new
         * DifferentialDrive.WheelState(Units.rpm_to_rads_per_sec(65.0 *
         ...
         * dynamics = drive.solveInverseDynamics(
         * new DifferentialDrive.ChassisState(Units.feet_to_meters(10.0),
         * Units.degrees_to_radians(45.0)),
         * new DifferentialDrive.ChassisState(Units.feet_to_meters(2.0),
         * Units.degrees_to_radians(9.0)));
         * assertEquals(1.0, dynamics.wheel_torque.left, 0.5);
         * assertEquals(1.0, dynamics.wheel_torque.right, 0.5);
         * assertEquals(11.0, dynamics.voltage.left, 1.0);
         * assertEquals(14.0, dynamics.voltage.right, 1.0);
         * // Max speed.
         * assertEquals(Units.feet_to_meters(13.0), drive.getMaxAbsVelocity(0.0, 12.0),
         * 1.0);
