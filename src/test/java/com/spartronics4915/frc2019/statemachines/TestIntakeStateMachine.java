package com.spartronics4915.frc2019.statemachines;
...
public class TestIntakeStateMachine
{
     ...
     * assertEquals(0, commandedState.leftMotor, EPSILON,
     * "motor must default to 0");
     * assertEquals(0, commandedState.rightMotor, EPSILON,
     * "motor must default to 0");
     ...
     * EPSILON, "motor must shoot");
     * assertEquals(IntakeStateMachine.kShootSetpoint, commandedState.rightMotor,
     * EPSILON, "motor must shoot");
     * assertEquals(commandedState.jawState, IntakeState.JawState.CLAMPED);
     * }
     * @Test
