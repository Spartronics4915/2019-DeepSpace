...
public class AutoModeSelector
{
    ...
    private static final AutoModeCreator[] mAllModes = {
            ...
            new AutoModeCreator("Middle: Drive Off Middle of Hab and Place Left Close Cargo", () -> new PlaceCargoFromMiddleMode(true)),
            new AutoModeCreator("Middle: Drive Off Middle of Hab and Palce Right Close Cargo", () -> new PlaceCargoFromMiddleMode(false)),
